...
const unsigned long CKN_SURRENDER = 0UL;
...
const unsigned long CKF_TOKEN_PRESENT = 1UL << 0;
const unsigned long CKF_REMOVABLE_DEVICE = 1UL << 1;
const unsigned long CKF_HW_SLOT = 1UL << 2;
const unsigned long CKF_ARRAY_ATTRIBUTE = 1UL << 30;
